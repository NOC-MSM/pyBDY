...
!------------------------------------------------------------------------------
   ln_use_CMES             = .false.
   sn_cmes_usr             = 'tprime'
   sn_cmes_pwd             = '*5TrsWI8i&Ds'
   sn_motu_server          = 'http://nrt.cmems-du.eu/motu-web/Motu'
   sn_cmes_model           = 'NORTHWESTSHELF_ANALYSIS_FORECAST_PHY_004_013-TDS'
   sn_ cmes_product        = 'MetO-NWS-PHY-dm-SAL'
   sn_cmes_variable        = 'so'
   sn_cmes_output          = 'cmes_dl_output.nc
   sn_cmes_config_template = './config/motu_config_template.ini'
   sn_cmes_config          = './config/motu_config.ini'
