...
!  grid information
!------------------------------------------------------------------------------
   sn_src_hgr = './tests/temp_test_002/parent.nc'
   sn_src_zgr = './tests/temp_test_002/parent.nc'
   sn_dst_hgr = './tests/temp_test_002/child.nc'
   sn_dst_zgr = './tests/temp_test_002/child.nc'
   sn_src_msk = './tests/temp_test_002/parent.nc'
   sn_bathy   = './tests/temp_test_002/child.nc'

!------------------------------------------------------------------------------
!  I/O
!------------------------------------------------------------------------------
   sn_src_dir = './tests/namelists/src_data_namelist_test_002.ncml' ! src_files/k
   sn_dst_dir = './tests/temp_test_002/'
