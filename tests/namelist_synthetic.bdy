...
!  grid information
!------------------------------------------------------------------------------
   sn_src_hgr = 'mesh_hgr.nc'
   sn_src_zgr = 'mesh_zgr.nc'
   sn_dst_hgr = 'mesh_hgr_zps.nc'
   sn_dst_zgr = 'mesh_zgr_zps.nc'
   sn_src_msk = 'mask.nc'
   sn_bathy   = 'bathy.nc'
...
!------------------------------------------------------------------------------
	...
	sn_tide_grid   = 'grid_tpxo9_atlas_30_v5.nc'
	sn_tide_dir    = 'TPXO9_atlas_v5_nc/'
